namespace LazyWelfare.AndroidCtrls.ImageExpleror.Adapter
{
    ...
    using LazyWelfare.AndroidCtrls.ImageExpleror.Collection;
    using LazyWelfare.AndroidCtrls.ImageExpleror.Model;
    using LazyWelfare.AndroidCtrls.ImageExpleror.Widget;
