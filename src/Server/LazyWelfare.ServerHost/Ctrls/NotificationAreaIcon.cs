...
namespace LazyWelfare.ServerHost.Ctrls
{
    ...
    public class NotificationAreaIcon : FrameworkElement
    {
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            {
                notifyIcon.Icon = LazyWelfare.ServerHost.Properties.Resources.blue_face;
            ...
            if (this.MenuStripItems != null && this.MenuStripItems.Count > 0)
            {
                notifyIcon.ContextMenuStrip = new Forms.ContextMenuStrip();
                notifyIcon.ContextMenuStrip.Items.AddRange(this.MenuStripItems.ToArray());
            }
        ...
        //private static readonly DependencyProperty FormsContextMenuProperty =
        ...
        //private List<Forms.MenuItem> MenuItems
        //{
        ...
        public static readonly DependencyProperty FormsContextMenuStripProperty =
            DependencyProperty.Register("MenuStripItems", typeof(List<Forms.ToolStripItem>), typeof(NotificationAreaIcon), new PropertyMetadata(new List<Forms.ToolStripItem>()));

        public List<Forms.ToolStripItem> MenuStripItems
        {
            get { return (List<Forms.ToolStripItem>)GetValue(FormsContextMenuStripProperty); }
            set { SetValue(FormsContextMenuStripProperty, value); }
        }
