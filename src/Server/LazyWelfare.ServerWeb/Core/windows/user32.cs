...
//        /// <summary>    
//        /// 该函数在指定的矩形里写入格式化文本，根据指定的方法对文  本格式化（扩展的制表符，字符对齐、折行等）。    
//        /// </summary>    
...
//        /// <summary>    
//        /// 该函数产生对其他线程的控制，如果一个线程没有其他消息在 其消息队列里。    
//        /// </summary>    
...
//        /// <summary>    
//        /// 该函数从调用线程的消息队列里取得一个消息并将其放于指定的结构。
...
//        /// 捕获鼠标的窗口接收所有的鼠标输入（无论光标的位置在哪里），
//        /// 除非点击鼠标键时，光标热点在另一个线程的窗口中。    
//        /// </summary>    
//        public static extern bool ReleaseCapture();
//        /// <summary>    
//        /// 准备指定的窗口来重绘并将绘画相关的信息放到一个 PAINTSTRUCT结构中。    
//        /// </summary>    
